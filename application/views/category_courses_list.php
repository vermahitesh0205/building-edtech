...
<!-- =====================Page Content======================= -->
				<div class="row">
					<div class="col-xl-12 col-lg-12">
						<div class="section3125">
							<h4 class="item_title">Courses List, Category : <?php if(!empty($category_dtl[0]->m_category_name)) echo $category_dtl[0]->m_category_name; ?></h4>
							<div class="la5lo1">
								<div class="row">
	...
	?>
									<div class="item col-lg-4 col-md-6 col-12 col-12 p-3">
	...
	<a href="<?php echo $dtl_link.$vl->m_course_id; ?>" class="fcrse_img">
			...
			<div class="row" style = "margin-left:5px;margin-bottom:10px;margin-top:10px;font-weight:bold;font-size:20px;"> Price :  <del><span title="Actual Price">₹ <?php echo $vl->m_course_price; ?></span></del> , <span title="Offer Price" style="color: green;"> ₹ <?php echo $vl->m_course_offer_price; ?></span></div>
