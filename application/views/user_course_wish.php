...
<!-- =====================Page Content======================= -->
				<div class="row">
					<div class="col-xl-12 col-lg-12">
						<div class="section3125">
							<h4 class="item_title">Course Wish</h4>
							<div class="la5lo1">
								<div class="row">
	...
	?>
        ...
        <a href="<?php echo $dtl_link.$vl->m_course_id; ?>" class="fcrse_img">
											...
											<div class="fcrse_content">
												...
												<div class="vdtodt">
													<span class="vdt14"><?php //echo $vl->added_on; ?></span>
												</div>
	<a href="<?php echo $dtl_link.$vl->m_course_id; ?>" class="crse14s"><?php echo $vl->m_course_title; ?></a>
												<a href="#" class="crse-cate">Category | <?php echo $vl->m_category_name; ?></a>
												<div class="auth1lnkprce">
													<p class="cr1fot">By <a href="#">John Doe</a></p>
													<div class="prce142"> ₹ <?php echo $vl->m_course_price; ?> , Offer ₹ <?php echo $vl->m_course_offer_price; ?></div>
												</div>
											</div>
										</div>
									</div>
    <?php } } else {?>
    	                         	<div class="col-md-12">
                                  		...
                                  		<!-- <h3 align="center" style="color: red">There is No Course In Your Wish List</h3> -->
                                  		<center><img src="<?php echo base_url ('assets/images/no-record.jpg')?>"></center>
