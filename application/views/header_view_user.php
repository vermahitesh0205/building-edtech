...
<header class="header clearfix">
	...
	<div class="search120">
		<div class="ui search">
			<div class="ui left icon input swdh10">
				<input class="prompt srch10" type="text" placeholder="Search for  Courses, Tests Series, Notes and more..">
	...
	if (isset($is_user_in) || $is_user_in == true) { ?>
		<div class="header_right">
			<ul>
				<li>
					<a href="<?php echo site_url('Logout'); ?>" class="upload_btn">Logout</a>
				</li>
				<li>
