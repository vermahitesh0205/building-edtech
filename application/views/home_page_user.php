		...
		<img src="' . base_url('admin/uploads/sliders/' . $banner->m_banner_image) . '" alt="' . $banner->m_banner_title . '" style="width:100%;">
						...
						?>
							...
							<div class="section3125 mt-50" width="100%">
								<h4 class="item_title">Recomended Courses<?php //echo //$vl->m_offer_title 
																			?></h4>
													...
													<div class="fcrse_content">
														...
														<div class="row">
															<div class="col-6 pr-1">
																<a class="add-to-wishlist" data-id="<?php echo $vl1->m_course_id ?>" data-type="1" style="font-size: 84%;"><button class="btn btn-primary btn-block"><span class="small">Add to wishlist</span></button></a>
															</div>
															<div class="col-6">
