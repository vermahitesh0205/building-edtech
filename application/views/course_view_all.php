...
<!-- =====================Page Content======================= -->
	...
	<div class="row" style = "margin-left:5px;margin-bottom:10px;margin-top:10px;font-weight:bold;font-size:20px;">
    	<span title="Offer Price" style="color: green;">₹<?php echo $vl->m_course_offer_price; ?></span>
    	<del><span title="Actual Price" class="ml-3" style="font-size:70%;color:#777;">₹<?php echo $vl->m_course_price; ?></span></del>
	</div>
	
												
												<a href="#" class="crse-cate crop-body-text" title="Category | <?php //echo $vl->m_category_name; ?>"> <?php //echo $vl->m_category_name; ?></a>
												<div class = "row">
													<div class = "col-6">
