									...
									<div class="tpc152">
										...
										<div class="section3126 mt-20">
											<div class="row">
												...
												<div class="col-md-4">
													<a href="#" class="value_props51">																											
														<?php echo get_settings('app_name'); ?> Course Quality Checklist																												
													</a>
												</div>
												<div class="col-md-4">
													<a href="#" class="value_props51">																											
												...
												<div class="col-md-4">
													<a href="#" class="value_props51">																											
														Instructor Promotional Agreements and <?php echo get_settings('app_name'); ?> Deals																												
													</a>
												</div>
												<div class="col-md-4">
													<a href="#" class="value_props51">																											
												...
												<div class="col-md-4">
													<a href="#" class="value_props50">
														...
														<div class="value_content">
															...
															<p>Learn how <?php echo get_settings('app_name'); ?> works and how to start learning.</p>
														</div>
													</a>
												</div>
												<div class="col-md-4">
									...
									<div class="tpc152">
										...
										<div class="section3126 mt-20">
											<div class="row">
												...
												<div class="col-md-4">
													<a href="#" class="value_props51">																											
														<?php echo get_settings('app_name'); ?> FAQ 																													
													</a>
												</div>
												<div class="col-md-4">
													<a href="#" class="value_props51">																											
